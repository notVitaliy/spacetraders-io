import { AccountResponse, AvailableLoanResponse, AvailableShipResponse, FlightPlanResponse, LoanType, LocationResponse, LocationsResponse, MarketplaceResponse, PurchaseResponse, StatusResponse } from './types';
interface Options {
